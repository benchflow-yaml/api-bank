#!/usr/bin/env python3
# BenchFlow Interface for API-bank
# This file is a template for integrating API-bank with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading API-bank benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "version": "1.0.0",
            "category": "general",
            "github": "https://github.com/THUDM/API-Bank",
